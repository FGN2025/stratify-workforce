...
import { Building2, Palette, Bell, Shield, Database, Save } from 'lucide-react';

const Settings = () => {
  const { tenant } = useTenant();
  const heroImageUrl = useSiteMediaUrl('settings_hero');
  ...
  return (
    <AppLayout>
      <div className="space-y-6">
        ...
        <PageHero
          title="Settings"
          subtitle="Configure your organization's preferences, branding, notifications, and security options"
