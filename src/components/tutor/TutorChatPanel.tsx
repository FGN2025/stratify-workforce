...
import { X, Send, Trash2, GraduationCap } from 'lucide-react';
...
export function TutorChatPanel() {
  const { isOpen, closeChat, messages, isStreaming, sendMessage, clearConversation } = useTutor();
  ...
  const contextLabel = pageContext.gameTitle
          ...
          <div className="space-y-4">
            {messages.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-12 text-center">
                ...
                <h3 className="font-medium text-lg mb-2">Hi! I'm Atlas</h3>
